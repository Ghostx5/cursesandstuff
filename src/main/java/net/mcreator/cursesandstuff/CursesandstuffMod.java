 ...
 *
 */
package net.mcreator.cursesandstuff;
...
@Mod("cursesandstuff")
public class CursesandstuffMod {
	public static final Logger LOGGER = LogManager.getLogger(CursesandstuffMod.class);
	public static final String MODID = "cursesandstuff";

	public CursesandstuffMod() {
